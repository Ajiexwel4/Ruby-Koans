...
class AboutSymbols < Neo::Koan
  ...
  # Answer:
  # The "Symbols" class hasn't got #include? method, but the "String" class includes it.
  ...
  # Answer:
  # Symbols haven't got some interesting method for operations with data.
  # Its couse that we need convertation symbols into other data type, and
  # this increase lines in our code, code will be less readable and bigger 
end
