...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # Answer:
    # send and __send__ are the same things. But #send can be overloaded 
    # and do other functions in different libraries. If we want to work 
    # with objects of any class, we need to use __send__ to be on the 
    # safe side.
  end
