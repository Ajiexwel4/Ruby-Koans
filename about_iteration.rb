...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Answer: 
    # #inject does iterations and takes a block with |memo, item|, 
    # memo is an argument of #inject or if no argument - first value of
    # object for iterations. After each iteration block return value 
    # and save in the memo.   
  ...
  # Answer:
  # Becouse it has own context. Variable "file" is a local for this code
  # This construction wraps the code and save it from outside changes.
