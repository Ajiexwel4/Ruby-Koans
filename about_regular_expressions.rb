...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # Answer:
    # when a sentence hasn't got values for matching with 
    # more than one value before * - returns zero(empty string)
  ...
  # Answer:
  # Becouse "greedy" operators mean that it will be searching all matches, 
  # maximum of posible iterations by the pattern. 
  # Result can include more symbols that we don't need
  ...
  # Answer:
  # [...] - 3 of any symbols between [ and ] check for presence in the word,
  # it depends of location "[...]" in the pattern
  # (|) - any of values before | or after | check for presence in the sentence.
